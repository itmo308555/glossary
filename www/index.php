...
<html lang="en" dir="ltr">
  ...
  <body>
    <h1>Glossary</h1>
    <div id="div1">
    <a href="./insert.php" style="text-decoration: none;padding-left: 50px;padding-top: 100px; color:red;">INSERT NEW WORD</a>
    <a href="./ontology.php" style="text-decoration: none;padding-left: 50px;padding-top: 100px; color:red;">Image Ontology</a>
